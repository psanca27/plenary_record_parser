...
def parseXML(xml_in, params, state):
    ...
    ENDING_MARK = re.compile(r'Schluss:?\s+[0-9]{1,2}[.:][0-9]{1,2}\s+Uhr')
    ...
    for page in pages:
        ...
        for textbox in textboxes:
            ...
            elif textbox['left'] < params['identation_bound_right_1'] - 3:
                textbox['left'] = 30
            else:
                textbox['left'] = 30
                textbox['top'] = textbox['top']-1000
